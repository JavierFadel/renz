                          ...
                          <div class="lg:flex lg:items-start">
                            <div class="lg:order-2 lg:ml-5">
                              <div class="max-w-xl overflow-hidden rounded-lg">
                                <img class="h-full w-full max-w-full object-cover" src="{{ Vite::asset($data['image']) }}" alt="product-image" />
                              </div>
                            </div>
                            ...
                            <div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
                              <div class="flex flex-row items-start lg:flex-col">
                                <button type="button" class="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-gray-900 text-center">
                                  <img class="h-full w-full object-cover" src="{{ Vite::asset($data['image']) }}" alt="" />
                                </button>
                        ...
                        <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2">
                          ...
                          <div class="mt-3 flex select-none flex-wrap items-center gap-1">
                            <label class="">
                              ...
                              <p class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">Comic</p>
                            </label>
                            <label class="">
                              <input type="radio" name="type" value="Whole Bean" class="peer sr-only" />
                              <p class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">Manga</p>
                            </label>
                            <label class="">
                              <input type="radio" name="type" value="Groud" class="peer sr-only" />
                              <p class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">Anime</p>
                            </label>
                          </div>
                          ...
                          <div class="mt-3 flex select-none flex-wrap items-center gap-1">
                            <label class="">
                              ...
                              <span class="mt-1 block text-center text-xs">IDR 80k/mo</span>
                            </label>
                            <label class="">
                              ...
                              <span class="mt-1 block text-center text-xs">IDR 100k/mo</span>
                            </label>
                            <label class="">
                              ...
                              <span class="mt-1 block text-center text-xs">IDR 120k/mo</span>
                            </label>
                          </div>
                  
                          <div class="mt-10 flex flex-col items-center justify-between space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0">
                            <div class="flex items-end">
                              <h1 class="text-2xl font-bold">IDR {{ round($data['price'], -3) }}</h1>
                              <span class="text-base">/month</span>
                            </div>
                  
                            <form action="{{ route('page.checkout.add') }}" method="POST" enctype="multipart/form-data">
                                @csrf

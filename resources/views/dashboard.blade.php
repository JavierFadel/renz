                    ...
                    <section class="bg-white">
                        <div class="py-6 px-4 mx-auto max-w-screen-xl">
                            <div class="bg-gray-50 border border-gray-200 rounded-lg p-8 md:p-12 mb-8">
                                ...
                                <h1 class="text-gray-900 text-3xl md:text-5xl font-extrabold mb-2">Tingkatkan Income dengan Bisnis Online</h1>
                                <p class="text-lg font-normal text-gray-500 mb-6">Shea shoes mengutamakan kepuasan pelanggan dengan memberikan pelayanan yang ramah dan kompeten. Tim kami yang berpengalaman dan terlatih siap membantu Anda dalam memilih produk yang sesuai dengan kebutuhan dan anggaran Anda. </p>
                            ...
                            <div class="grid md:grid-cols-2 gap-8">
                                <div class="bg-gray-50 border border-gray-200 rounded-lg p-8 md:p-12">
                                    ...
                                    <h2 class="text-gray-900 text-3xl font-extrabold mb-2">Panduan fashion modern</h2>
                                    <p class="text-lg font-normal text-gray-500 mb-4">Selain itu, Shea Shoes juga menawarkan harga yang kompetitif dan berbagai penawaran spesial untuk memberikan nilai tambah kepada pelanggan kami. </p>
                                ...
                                <div class="bg-gray-50 border border-gray-200 rounded-lg p-8 md:p-12">
                                    ...
                                    <h2 class="text-gray-900 text-3xl font-extrabold mb-2">Tips Ganteng ala Aldi Taher</h2>
                                    <p class="text-lg font-normal text-gray-500 mb-4">"Beliau ini bukan sembarang beliau, mengerikan", begitu ucap Mahrus Fazri, seorang desainer muda yang telah mendunia.</p>
                                    <a href="#" class="text-blue-600 hover:underline font-medium text-lg inline-flex items-center">Read more
                                        <svg class="w-3.5 h-3.5 ml-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                                        </svg>
